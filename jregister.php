...
<form action="dbOrgRegister.php" method="post" onsubmit="return check(this)" enctype="multipart/form-data" name = "form1">
<table border="0" cellpadding="10" cellspacing="1" width="1000" align="center">
<tr class="tableheader"><td>EMPLOYER REGISTRAION</td><td></td><td></td></tr>
<tr class="tablerow">
	<td>User name</td><td>:</td>
	<td><input type="text" name="u_name" ><span id='a' style="color: red;"></span></td>
</tr>
<tr class="tablerow"><td>Organization name</td><td>:</td><td><input type="text" name="o_name"><span id='b' style="color: red;"></span></td></tr>
...
<tr class="tablerow"><td>About the company</td><td>:</td><td><textarea rows="5" cols="20" name="abt"></textarea><span id='f' style="color: red;"></span></td></tr>
